...
package natural.silver.world.structure;
...
public class WerewolfspawnStructure extends NaturalmoonModElements.ModElement {
	public WerewolfspawnStructure(NaturalmoonModElements instance) {
		super(instance, 88);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 1000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("naturalmoon", "under"));
						if (template == null)
							return false;
