...
public class NaturalMoonmainProcedure extends NaturalmoonModElements.ModElement {
	public NaturalMoonmainProcedure(NaturalmoonModElements instance) {
		super(instance, 25);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure NaturalMoonmain!");
			return;
		}
