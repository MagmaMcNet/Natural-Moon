...
public class BloodyWerewolfHideItem extends NaturalmoonModElements.ModElement {
	@ObjectHolder("naturalmoon:bloody_werewolf_hide")
	public static final Item block = null;
	public BloodyWerewolfHideItem(NaturalmoonModElements instance) {
		super(instance, 22);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("bloody_werewolf_hide");
		}
