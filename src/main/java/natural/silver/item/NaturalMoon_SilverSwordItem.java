...
public class NaturalMoon_SilverSwordItem extends NaturalmoonModElements.ModElement {
	@ObjectHolder("naturalmoon:natural_moon_silver_sword")
	public static final Item block = null;
	public NaturalMoon_SilverSwordItem(NaturalmoonModElements instance) {
		super(instance, 9);
	}
	...
	public void initElements() {
		...
		}, 3, -3f, new Item.Properties().group(NaturalMoonItemGroup.tab)) {
			@Override
		...
		}.setRegistryName("natural_moon_silver_sword"));
	}
}
