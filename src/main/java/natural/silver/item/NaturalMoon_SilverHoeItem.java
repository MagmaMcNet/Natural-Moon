...
public class NaturalMoon_SilverHoeItem extends NaturalmoonModElements.ModElement {
	@ObjectHolder("naturalmoon:natural_moon_silver_hoe")
	public static final Item block = null;
	public NaturalMoon_SilverHoeItem(NaturalmoonModElements instance) {
		super(instance, 11);
	}
	...
	public void initElements() {
		...
		}, -3f, new Item.Properties().group(NaturalMoonItemGroup.tab)) {
			@Override
		...
		}.setRegistryName("natural_moon_silver_hoe"));
	}
}
