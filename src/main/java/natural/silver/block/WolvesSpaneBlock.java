...
import natural.silver.procedures.Wolves_spane_MainProcedure;
...
public class WolvesSpaneBlock extends NaturalmoonModElements.ModElement {
	@ObjectHolder("naturalmoon:wolves_spane")
	public static final Block block = null;
	public WolvesSpaneBlock(NaturalmoonModElements instance) {
		super(instance, 15);
	}
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new BlockItem(block, new Item.Properties().group(NaturalMoonItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				Wolves_spane_MainProcedure.executeProcedure($_dependencies);
			}
		}
