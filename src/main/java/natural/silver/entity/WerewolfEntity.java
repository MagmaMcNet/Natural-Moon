...
import natural.silver.procedures.WerewolfEntityDiesProcedure;
import natural.silver.itemgroup.NaturalMoonItemGroup;
import natural.silver.item.BloodyWerewolfHideItem;
...
public class WerewolfEntity extends NaturalmoonModElements.ModElement {
	public static EntityType entity = null;
	public WerewolfEntity(NaturalmoonModElements instance) {
		super(instance, 18);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1.1f, 2.3000000000000003f))
						.build("werewolf").setRegistryName("werewolf");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -1, -5308416, new Item.Properties().group(NaturalMoonItemGroup.tab))
				.setRegistryName("werewolf_spawn_egg"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			biome.getSpawns(EntityClassification.MONSTER).add(new Biome.SpawnListEntry(entity, 2, 1, 2));
		}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(CustomEntity.class, renderManager -> {
			return new MobRenderer(renderManager, new ModelNaturalMoon_Modded_werewolf(), 0.5f) {
				@Override
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, HunterEntity.CustomEntity.class, false, false));
			this.goalSelector.addGoal(2, new MeleeAttackGoal(this, 1.2, false));
			this.goalSelector.addGoal(3, new LookAtGoal(this, HunterEntity.CustomEntity.class, (float) 30));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(BloodyWerewolfHideItem.block, (int) (1)));
		}
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("naturalmoon:werewolf_death"));
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				WerewolfEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class ModelNaturalMoon_Modded_werewolf extends EntityModel {
		...
		public ModelNaturalMoon_Modded_werewolf() {
			textureWidth = 128;
			textureHeight = 128;
			...
			lowerbody_r1.cubeList.add(new ModelBox(lowerbody_r1, 34, 0, -4.0F, -8.4734F, -2.3254F, 8, 9, 5, 0.0F, false));
			...
			upperbody_r2.cubeList.add(new ModelBox(upperbody_r2, 0, 0, -5.0F, -11.7081F, -2.4776F, 10, 13, 7, 0.0F, false));
			...
			neck_r1.cubeList.add(new ModelBox(neck_r1, 0, 20, -0.25F, 0.75F, -6.75F, 8, 11, 6, 0.0F, false));
			...
			Head.setRotationPoint(4.0F, 7.0F, -3.0F);
			Body.addChild(Head);
			...
			LArm.setRotationPoint(9.0F, 7.0F, 0.0F);
			Body.addChild(LArm);
			...
			RArm.setRotationPoint(-1.0F, 7.0F, 0.0F);
			Body.addChild(RArm);
			...
			LLeg.setRotationPoint(3.75F, -14.0F, 1.5F);
			Werewolf.addChild(LLeg);
			LLeg.cubeList.add(new ModelBox(LLeg, 32, 60, -1.75F, 12.0F, -5.5F, 4, 2, 6, 0.0F, false));
			claw_r11 = new RendererModel(this);
			claw_r11.setRotationPoint(0.15F, 14.0F, -6.5F);
			...
			RLeg.setRotationPoint(-4.25F, -14.0F, 1.5F);
