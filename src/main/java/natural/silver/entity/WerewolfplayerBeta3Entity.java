...
public class WerewolfplayerBeta3Entity extends NaturalmoonModElements.ModElement {
	public static EntityType entity = null;
	public WerewolfplayerBeta3Entity(NaturalmoonModElements instance) {
		super(instance, 114);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.7f, 0.8f)).build("werewolfplayer_beta_3")
						.setRegistryName("werewolfplayer_beta_3");
