...
public class WerewolfplayerAlpha3Entity extends NaturalmoonModElements.ModElement {
	public static EntityType entity = null;
	public WerewolfplayerAlpha3Entity(NaturalmoonModElements instance) {
		super(instance, 121);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 0.8f))
						.build("werewolfplayer_alpha_3").setRegistryName("werewolfplayer_alpha_3");
