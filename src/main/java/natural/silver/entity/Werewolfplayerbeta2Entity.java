...
public class Werewolfplayerbeta2Entity extends NaturalmoonModElements.ModElement {
	public static EntityType entity = null;
	public Werewolfplayerbeta2Entity(NaturalmoonModElements instance) {
		super(instance, 113);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.7f, 0.8f)).build("werewolfplayer_beta_2")
						.setRegistryName("werewolfplayer_beta_2");
