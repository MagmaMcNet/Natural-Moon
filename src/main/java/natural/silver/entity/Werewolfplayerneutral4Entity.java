...
public class Werewolfplayerneutral4Entity extends NaturalmoonModElements.ModElement {
	public static EntityType entity = null;
	public Werewolfplayerneutral4Entity(NaturalmoonModElements instance) {
		super(instance, 119);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.7f, 0.8f))
						.build("werewolfplayerneutral_4").setRegistryName("werewolfplayerneutral_4");
