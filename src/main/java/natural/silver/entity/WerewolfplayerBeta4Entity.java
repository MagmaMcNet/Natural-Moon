...
public class WerewolfplayerBeta4Entity extends NaturalmoonModElements.ModElement {
	public static EntityType entity = null;
	public WerewolfplayerBeta4Entity(NaturalmoonModElements instance) {
		super(instance, 115);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.7f, 0.8f)).build("werewolfplayer_beta_4")
						.setRegistryName("werewolfplayer_beta_4");
